    ...
    <div className="container mx-auto px-4 py-6 ">
      ...
      >
        <AnimatePresence>
          {showModal && (
            <ModalOfManualPaymentToSeeDetails
              ...
              infoOfManualPaymentById={infoOfManualPaymentById}
              setShowImageModal={setShowImageModal}
              setNewStatusOfManualPayment={setNewStatusOfManualPayment}
              buttonsActionsOfVerifyPayment={buttonsActionsOfVerifyPayment}
            />
          )}
        </AnimatePresence>
        <AnimatePresence>
        ...
        <div className="max-md:flex-col max-md:items-start mb-6 flex items-center justify-between w-full">
          <div className="space-y-2">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              En esta sección puedes gestionar los pagos externos realizados.
            </p>
          </div>
          <div>
        ...
        {dataFiltered && dataFiltered.data.length > 0 ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 items-center justify-items-center content-center w-[100%]">
