...
export const Header = () => {
    ...
    return (
        <header className={`header ${scrolled ? 'scrolled' : ''} px-24`}>
            <div className='flex flex-row justify-between items-center w-full'>
                <div>
                    {scrolled ?
                        <img src={LogoHeaderIcon} alt='logo' className='w-36'/> :
                        <img src={LogoHeaderWhiteIcon} alt='logo' className='w-36'/>
                    }
                </div>
                <div className=''>
                    {
                    ...
                    <button className='btn-style505 border border-[#bd9554] px-4 py-2 w-49'>
                        <span className='text-[#bd9554]'>+</span>522222480015
                    </button>
                </div>
